...
public class WechatConfigs {
	private static Log logger = LogFactory.getLog(WechatConfigs.class);
	...
	static void init() {
		...
		props.setProperty("wechat.http.connectionTimeout", "20000");
		props.setProperty("wechat.http.readTimeout", "120000");
		props.setProperty("wechat.http.retryCount", "3");
		// 读取自定义配置
